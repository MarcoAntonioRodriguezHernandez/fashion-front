<x-layouts.master-layout title="Editar orden de pago" cardTitle="Editar orden de pago">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <select name="order_marketplace_id" id="order_marketplace_id" class="form-select form-control"
                                        ...
                                        @foreach ($orderMarketplaces as $ordermarketplace)
                                            <option value="{{ $ordermarketplace->id }}" @if ($ordermarketplace->id == $data->ordermarketplace->id) selected @endif>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <x-layouts.inputs typeInput="justInput" name="total" id="total" typeofInput="number" min="0"
                                        placeholder="Total" value="{{ old('name', $data->total) }}" /> 
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
