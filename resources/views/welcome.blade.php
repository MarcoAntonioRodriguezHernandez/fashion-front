...
<x-layouts.card-header :createRoute="route('welcome')" :createText="__('Crear Producto')" />
            ...
            <tbody class="fw-semibold text-gray-600">
                <tr>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a href="apps/ecommerce/catalog/edit-product.html"
                                ...
                                <span class="symbol-label"
                                    style="background-image:url({{ asset ('media//stock/ecommerce/1.png')  }});"></span>
                            </a>
                            <!--end::Thumbnail-->
                            <div class="ms-5">
                                <!--begin::Title-->
                    ...
                    <td class="text-end pe-0">
                        <span class="fw-bold">01165009</span>
                    </td>
