<x-layouts.master-layout title="Crear ejemplo" cardTitle="Crear ejemplo">

    <div class="form_padding">
        <!--begin::Form-->
        <form id="staffAdd" class="form d-flex flex-column flex-lg-row" action="{{ route('example.create') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                            ...
                            <div class="image-input-wrapper w-250px h-250px" style="background-image: url('{{asset('media/avatars/blank.png')}}')"></div>
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="d-flex flex-column gap-7 gap-lg-10">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="d-flex gap-3">
                                        <x-layouts.inputs typeInput="justInputNumber" typeofInput="number" name="value" id="value" placeholder="Valor" min="0" value="{{ old('value') }}" />
                                    </div>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--begin::Input-->
                                    <div class="d-flex gap-3">
                                        <x-layouts.inputs typeInput="justInputNumber" typeofInput="number" name="quantity" id="quantity" placeholder="Valor" min="0" value="{{ old('quantity') }}" />
                                    </div>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                 ...
                                 <div class="mb-10 fv-row">
                                    ...
                                    <!--begin::Input-->
                                    <div class="d-flex gap-3">
                                            <input type="datetime-local" class="form-control" name="creation" id="creation" value="{{ old('creation') }}">
                                    </div>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--begin::Input-->
                                    <div class="d-flex gap-3">
                                        <select name="status" id="status" class="form-select form-control" data-control="select2" data-hide-search="true"
                                        data-placeholder="">
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{ route('example.index') }}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Cancelar</a>
                        <!--end::Button-->
                        <!--begin::Button-->
