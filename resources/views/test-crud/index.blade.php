<x-layouts.master-layout title="Administración del staff" cardTitle="Administración del staff">

    <x-layouts.card-header :createRoute="route('welcome')" :createText="__('Agregar miembros del staff')" />
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5"
                ...
                <thead>
                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Sucursal</th>
                ...
                <tbody class="fw-semibold text-gray-600">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="apps/ecommerce/catalog/edit-product.html"
                                    ...
                                    <span class="symbol-label"
                                        style="background-image:url({{ asset ('media/avatars/300-2.jpg')  }});"></span>
                                </a>
                                <!--end::Thumbnail-->
                                <div class="ms-5">
                                    <!--begin::Title-->
                                    <a href="apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        data-kt-ecommerce-product-filter="product_name">Paulina Rosas</a>
                                    <!--end::Title-->
                                </div>
                            </div>
                        </td>
                        <td>
                            <span class="fw-bold">testuser1@gmail.com</span>
                        </td>
                        <td>LIVERPOOL INSURGENTES</td>
                        <td class="text-start">
                            ...
                            <a class="menu-link px-2" style="cursor: pointer;">
                        ...
                        <td class="min-w-125px">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="apps/ecommerce/catalog/edit-product.html"
                                    class="symbol symbol-50px">
                                    <span class="symbol-label"
                                        style="background-image:url({{ asset ('media/avatars/300-5.jpg')  }});"></span>
                                </a>
                                <!--end::Thumbnail-->
                                <div class="ms-5">
                                    <!--begin::Title-->
                                    <a href="apps/ecommerce/catalog/edit-product.html"
                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                        data-kt-ecommerce-product-filter="product_name">Luis Gomez</a>
                                    <!--end::Title-->
                                </div>
                            </div>
                        </td>
                        <td>
                            <span class="fw-bold">testuser2abcs@gmail.com</span>
                        </td>
                        <td>LIVERPOOL MONTERREY GALERIAS</td>
                        <td class="text-start">
                            <a href="#" class="menu-link px-2">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <td class="min-w-125px">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="apps/ecommerce/catalog/edit-product.html"
                                    class="symbol symbol-50px">
                                    <span class="symbol-label"
                                        style="background-image:url({{ asset ('media/avatars/300-1.jpg')  }});"></span>
                                </a>
                                <!--end::Thumbnail-->
                                <div class="ms-5">
                                    <!--begin::Title-->
                                    <a href="apps/ecommerce/catalog/edit-product.html"
                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                        data-kt-ecommerce-product-filter="product_name">Mike Posner</a>
                                    <!--end::Title-->
                                </div>
                            </div>
                        </td>
                        <td>
                            <span class="fw-bold">abcdefgtest@gmail.com</span>
                        </td>
                        <td>LIVERPOOL POLANCO</td>
                        <td class="text-start">
                            <a href="#" class="menu-link px-2">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <td class="min-w-125px">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="apps/ecommerce/catalog/edit-product.html"
                                    class="symbol symbol-50px">
                                    <span class="symbol-label"
                                        style="background-image:url({{ asset ('media/avatars/300-10.jpg')  }});"></span>
                                </a>
                                <!--end::Thumbnail-->
                                <div class="ms-5">
                                    <!--begin::Title-->
                                    <a href="apps/ecommerce/catalog/edit-product.html"
                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                        data-kt-ecommerce-product-filter="product_name">Selena López</a>
                                    <!--end::Title-->
                                </div>
                            </div>
                        </td>
                        <td>
                            <span class="fw-bold">selenatest@gmail.com</span>
                        </td>
                        <td>LIVERPOOL PARQUE LINDAVISTA</td>
                        <td class="text-start">
                            <a href="#" class="menu-link px-2">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                    ...
                    <tr>
                        <td class="min-w-125px">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="apps/ecommerce/catalog/edit-product.html"
                                    class="symbol symbol-50px">
                                    <span class="symbol-label"
                                        style="background-image:url({{ asset ('media/avatars/300-4.jpg')  }});"></span>
                                </a>
                                <!--end::Thumbnail-->
                                <div class="ms-5">
                                    <!--begin::Title-->
                                    <a href="apps/ecommerce/catalog/edit-product.html"
                                        class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                        data-kt-ecommerce-product-filter="product_name">Luisa Alvarez</a>
                                    <!--end::Title-->
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="text-start">
                            ...
                            <a class="menu-link px-2" style="cursor: pointer;" onclick="mostrarSweetAlert()">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M15.375 4.5H2.625M14.1248 6.375L13.7798 11.55C13.647 13.5405 13.581 14.5358 12.9323 15.1425C12.2835 15.75 11.2853 15.75 9.29025 15.75H8.70975C6.71475 15.75 5.7165 15.75 5.06775 15.1425C4.419 14.5358 4.35225 13.5405 4.22025 11.55L3.87525 6.375M7.125 8.25L7.5 12M10.875 8.25L10.5 12"
