<x-layouts.master-layout title="Editar tipo de pago" cardTitle="Editar {{ $data->name }}">

    <div class="form_padding">
        <!--begin::Form-->
        <form id="staffAdd" class="form d-flex flex-column flex-lg-row" action="{{ route('base.payment_type.edit') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="d-flex gap-3">
                                        <x-layouts.inputs typeInput="justInput" typeofInput="text" name="name" id="name" placeholder="Nombre" min="0" value="{{ $data->name }}" />
                                    </div>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
