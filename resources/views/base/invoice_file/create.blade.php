<x-layouts.master-layout title="Crear archivo de factura" cardTitle="Crear archivo de factura">

    <div class="form_padding">
        <!--begin::Form-->
        <form id="staffAdd" class="form d-flex flex-column flex-lg-row" action="{{ route('base.invoice_file.create') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="d-flex flex-column gap-7 gap-lg-10">
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{ route('base.invoice_file.index') }}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Cancelar</a>
                        <!--end::Button-->
                        <!--begin::Button-->
