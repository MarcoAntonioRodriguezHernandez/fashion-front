<x-layouts.master-layout title="Crear Esquema de precios" cardTitle="Crear Esquema de precios">

    <div class="form_padding">
        <!--begin::Form-->
        <form id="staffAdd" class="form d-flex flex-column flex-lg-row" action="{{ route('base.pricing_schemes.create') }}" method="POST">
            @csrf
            <!--begin::Main column-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <select name="sku_4_id" id="sku_4_id"
                                        ...
                                        @foreach ($data['skus'] as $sku)
                                            <option value="{{ $sku->id }}" @selected($sku->id == old('sku_4_id'))>
                                                {{ $sku->sku }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <select name="sku_8_id" id="sku_8_id"
                                        ...
                                        <option selected hidden disabled>-- Elige una opción --</option>
                                        @foreach ($data['skus'] as $sku)
                                            <option value="{{ $sku->id }}" @selected($sku->id == old('sku_8_id'))>
                                                {{ $sku->sku }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="d-flex gap-3">
                                        <x-layouts.inputs typeInput="justInputNumber" typeofInput="number" name="msrp" id="msrp" placeholder="MSRP" min="0" value="{{ old('msrp') }}" />
                                    </div>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--begin::Input-->
                                    <div class="d-flex gap-3">
                                        <x-layouts.inputs typeInput="justInputNumber" typeofInput="number" name="increase" id="increase" placeholder="Incremento" min="0" value="{{ old('increase') }}" />
                                    </div>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
