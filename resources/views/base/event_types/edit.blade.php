<x-layouts.master-layout title="Editar Tipo de Evento" cardTitle="Editar {{ $data->name }}">

    <div class="form_padding">
        <!--begin::Form-->
        <form id="staffAdd" class="form d-flex flex-column flex-lg-row" action="{{ route('base.event_types.create') }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <!--end::Tab content-->
                <x-btn-cancel-save routeCancel="{{ route('base.event_types.index') }}" :module="ModuleAliases::EVENT_TYPE" />
            </div>
            <!--end::Main column-->
        </form>
    </div>
