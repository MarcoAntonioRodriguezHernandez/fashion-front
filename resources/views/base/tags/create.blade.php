<x-layouts.master-layout title="Crear Etiqueta" cardTitle="Crear Etiqueta">

    <div class="form_padding">
        <!--begin::Form-->
        <form id="staffAdd" class="form d-flex flex-column flex-lg-row" action="{{ route('base.tags.create') }}"
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="d-flex flex-column gap-7 gap-lg-10">
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <x-btn-create-cancel 
                        routeCancel="{{ route('base.tags.index') }}" 
