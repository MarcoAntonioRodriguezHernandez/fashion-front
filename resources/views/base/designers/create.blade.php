<x-layouts.master-layout title="Crear diseñador" cardTitle="Crear diseñador">

    <div class="form_padding">
        <!--begin::Form-->
        <form id="staffAdd" class="form d-flex flex-column flex-lg-row" action="{{ route('base.designers.create') }}" method="POST" enctype="multipart/form-data">
            @csrf
