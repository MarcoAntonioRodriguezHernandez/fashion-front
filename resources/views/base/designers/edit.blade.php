<x-layouts.master-layout title="Editar diseñador" cardTitle="Editar {{ $data->name }}">

    <div class="form_padding">
        <!--begin::Form-->
        <form id="staffAdd" class="form d-flex flex-column flex-lg-row" action="{{ route('base.designers.edit') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
