    ...
    if (e) {
        var i = {
            ...
            a = function() {
                var e = 0,
                    t = m();
                !0 === l() && (e += t), !0 === n.options.checkUppercase && !0 === s() && (e += t), !0 === n.options.checkLowercase && !0 === u() && (e += t), !0 === n.options.checkDigit && !0 === d() && (e += t), !0 === n.options.checkChar && !0 === c() && (e += t), n.score = e, f(), enableButton()
            },
            l = function() {
            ...
            enableButton = function() {
                if (n.score >= 100) {
                    n.submitButton.removeAttribute("disabled");
                } else {
                    n.submitButton.setAttribute("disabled", "disabled");
                }
            };
		...
		var i = {
			...
			o = function() {
                ...
                if (n.menuObject) {
                    if (n.toggleElement) {
                        ...
                        // Check if n.menuObject has a 'shown' property before using it
                        if (n.menuObject.shown && typeof n.menuObject.shown === "function") {
                            n.menuObject.shown(function () {
			...
			m = function() {
                if (n.layout === "menu") {
                    ...
                    if (n.contentElement && n.formElement) {
                        if ("on" === e && !n.contentElement.contains(n.formElement)) {
                            n.contentElement.prepend(n.formElement);
                            n.formElement.classList.remove("d-none");
                        } else if ("off" === e && n.contentElement.contains(n.formElement)) {
			...
			f = function() {
                if (n.menuObject) {
                    ...
                    // Check if n.menuObject has an 'open' method before using it
                    if (n.menuObject.open && typeof n.menuObject.open === "function") {
                        n.menuObject.open(n.element);
                    }
                }
            },            
			p = function() {
	...
	return {
		init: function() {
			...
			n = document.querySelector("#kt_app_sidebar_toggle"), e = document.querySelector("#kt_app_sidebar_navs_wrappers"), t = document.querySelector("#kt_app_sidebar"), n && null !== (i = KTToggle.getInstance(n)) && (i.on("kt.toggle.change", (function() {
				...
				axios.post(window.sessionPutRoute, { key: "aside-active", value: i.isEnabled() ? "on" : "off" });
