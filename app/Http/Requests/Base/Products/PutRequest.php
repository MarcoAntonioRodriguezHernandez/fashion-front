...
class PutRequest extends FormRequest
{
    ...
    {
        return [
            'keep_images' => 'required_without:images|array',
            'images' => 'required_without:keep_images|array',
            'images.*' => 'required_with:images|array',
            'images.*.color_id' => 'required_with:images|integer|exists:colors,id',
            'images.*.camera_perspective' => 'required_with:images|string|in:front,back,left,right',
        ];
    }
