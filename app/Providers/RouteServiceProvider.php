    ...
    public function boot(): void
    {
        ...
        $this->routes(function () {
            ...
            if (config('services.conspiracy.sync_enabled')) {
                Route::middleware('api')
                    ->prefix('api/v1/db-sync')
                    ->group(base_path('routes/database_sync/store/api.php'))
                    ->group(base_path('routes/database_sync/user/api.php'))
                    ->group(base_path('routes/database_sync/payment_type/api.php'))
                    ->group(base_path('routes/database_sync/invoice/api.php'))
                    ->group(base_path('routes/database_sync/provider/api.php'))
                    ->group(base_path('routes/database_sync/tag/api.php'))
                    ->group(base_path('routes/database_sync/characteristic/api.php'))
                    ->group(base_path('routes/database_sync/color/api.php'))
                    ->group(base_path('routes/database_sync/size/api.php'))
                    ->group(base_path('routes/database_sync/category/api.php'))
                    ->group(base_path('routes/database_sync/designer/api.php'))
                    ->group(base_path('routes/database_sync/sku/api.php'))
                    ->group(base_path('routes/database_sync/pricing_scheme/api.php'))
                    ->group(base_path('routes/database_sync/variant/api.php'))
                    ->group(base_path('routes/database_sync/product/api.php'))
                    ->group(base_path('routes/database_sync/item/api.php'))
                    ->group(base_path('routes/database_sync/supply/api.php'))
                    ->group(base_path('routes/database_sync/order/api.php'))
                    ->group(base_path('routes/database_sync/product_image/api.php'));
            }
